...
@section('TopSectionName', 'Manage Ojo Executives')
@section('style')
    <style>
    ...
    <section class="button-area">
        <div class="container box_1170 border-top-generic">
            <div class="row">
                ...
                <div class="col-md-12">
                    <form class="form-contact contact_form" action="{{ route('executives.addEntry') }}"
                    ...
                    @if ($executivesAuth)
                        <p class="mt-3 float-right">
                            <strong>Last updated by:</strong> {{ $executivesAuth->user->name ?? 'Unknown' }} at
                            {{ $executivesAuth->updated_at->format('d, M, Y. h:i A') }}
                        </p>
                    @endif
                </div>
            </div>
                            ...
                            <div class="table-row">
                                ...
                                <div class="percentage">
                                    <div class="btn-group btn-group-sm">
                                        <a href="{{ route('executives.edit', $record) }}" class="btn bg-info">
                                            <i class="fas fa-edit"></i>
                                        </a>
                                        <form action="{{ route('executives.delete', $record->id) }}" method="POST"
