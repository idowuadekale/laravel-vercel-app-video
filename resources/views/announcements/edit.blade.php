...
@section("TopSectionName", "Edit Announcements")
@section("style")
<style>
#unsplash-results {
    max-height: 60vh;
...
<section class="button-area">
    <div class="container box_1170 border-top-generic">
        <div class="row">
            ...
            <div class="col-md-12">
                <form class="form-contact contact_form" action="{{ route('announcements.update', $announcement) }}"
                    ...
                    <div class="row">
                        <div class="col-sm-6">                             
                            <div class="form-group">
                                ...
                                <input type="text" name="title" id="title" class="form-control" minlength="5"
                                    maxlength="150" required placeholder="Enter Title (ex: Fellowship Meeting)"
                                ...
                                <div class="input-group-icon mt-10">
                                    ...
                                    <div class="form-select" id="default-select">
                                        <select name="tag" id="tag" required>
                                            <option value="{{ old('tag', $announcement->tag ?? '') }}" selected>
                                                {{ $announcement->tag }}
                                            </option>
                        ...
                        <div class="col-12">                           
                            <div class="form-group">
                                ...
                                <span class="text-danger">*</span>
                                <input type="hidden" name="body" id="body" required value="{{ old('body', $announcement->body ?? '') }}">
                         ...
                         <div class="col-12">                               
                            <div class="form-group">                                 
                                ...
                                <div class="d-flex">                                 
                                    ...
                                    class="img-fluid m-2" title="Existing Image"
                                    style="max-height:200px; display: {{ old('image_url', $announcement->image_url ?? false) ? 'block' : 'none' }}">
                                    <img src="" id="selected-image-preview" class="img-fluid m-2" style="max-height:200px;">
                               </div>
                            </div>
                        </div>
                    </div>
