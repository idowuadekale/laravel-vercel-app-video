...
@section("title", "Activities - Lasu C&S Chapter")
@section("TopSectionName", "Manage Activities")
@section("style")
<style>
</style>
@endsection
...
<section class="button-area">
    <div class="container box_1170 border-top-generic">
        <div class="row">           
            ...
            <div class="col-lg-12">                  
                <form class="form-contact contact_form" id="activityForm" action="{{route("activities.addEntry")}}"
                ...
                <p class="mt-3 float-right">
                    <strong>Last updated by:</strong> {{ $activitiesAuth->user->name ?? 'Unknown' }} at
                    {{ $activitiesAuth->updated_at->format('d, M, Y. h:i A') }}
                </p>
                @endif
            </div>
        </div>
            ...
            <div class="progress-table-wrap">
                <div class="progress-table">
                    <div class="table-head">
                        <div class="serial" style="width: 300px;">Day</div>
                        <div class="percentage">Title</div>
                        <div class="serial" style="width: 500px;">Body</div>
                        <div class="visit" style="width: 300px;">Begin_End</div>
                    ...
                    <div class="table-row">
                        ...
                        <div class="serial" style="width: 500px;">
                            {{ Str::limit(strip_tags(html_entity_decode($activity->body)), 100, '...') }}
                        </div>
                        ...
                        <div class="percentage">                             
                            <div class="btn-group btn-group-sm">
                                <a href="{{ route('activities.edit', $activity) }}" class="btn bg-info">
