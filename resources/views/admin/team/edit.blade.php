...
@section("TopSectionName", "Edit LASU C&S Leaders")
@section("style")
<style>
</style>
@endsection
...
<section class="button-area">
    <div class="container box_1170 border-top-generic">
        <div class="row">
            ...
            <div class="col-md-12">
                <form class="form-contact contact_form" action="{{ route('team.update', $team) }}"
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="position" id="position" class="form-control" minlength="5"
                                    maxlength="150" required autocomplete="on" placeholder="Enter Position"
                        ...
                        <div class="col-sm-6">
                            <div class="mt-2">
                                @if ($team->image)
                                <img src="{{ asset('storage/' . $team->image) }}" class="rounded border" width="150"
