...
@section('title', 'Home Image - Lasu C&S Chapter')
@section('TopSectionName', 'Manage Home Images')
@section('style')
    <style>
    </style>
@endsection
    ...
    <section class="button-area">
        <div class="container box_1170 border-top-generic">
            <div class="row">
                ...
                <div class="col-md-12">
                    <form class="form-contact contact_form" action="{{ route('hero.store') }}" enctype="multipart/form-data"
                    ...
                    @if ($heroAuth)
                        <p class="mt-3 float-right">
                            <strong>Last updated by:</strong> {{ $heroAuth->user->name ?? 'Unknown' }} at
                            {{ $heroAuth->updated_at->format('d, M, Y. h:i A') }}
                        </p>
                    @endif
                </div>
            </div>
            <div class="section-top-border">
                ...
                <div class="progress-table-wrap">
                    <div class="progress-table">
                        <div class="table-head">
                            ...
                            <div class="percentage">Image_URL</div>
                        ...
                        @foreach ($heros as $hero)
                            <div class="table-row">
                                ...
                                <div class="percentage">
                                    @if ($hero->image)
                                        {{ \Illuminate\Support\Str::limit(strip_tags($hero->image), 30, '...') }}
                                    @else
                                        N/A
                                    @endif
                                </div>
                ...
                <div class="container">
                    <nav class="blog-pagination justify-content-center d-flexo mt-4">
                        {{ $heros->links('pagination::bootstrap-5') }}
                    </nav>
                </div>
