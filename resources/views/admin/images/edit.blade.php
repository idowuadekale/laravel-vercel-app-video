                ...
                <form class="form-contact contact_form" action="{{ route('images.update', $group) }}"
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="my-2">
                                @if ($group->image)
                                <img src="{{ asset('storage/' . $group->image) }}" class="rounded border" width="150"
                                    height="150" alt="Group Image">
                                @endif
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                ...
                                <small class="text-warning">(optional)</small>
                                <input type="text" name="short_bio" id="short_bio" class="form-control" minlength="3"
                                    maxlength="150" placeholder="Enter Short Title (ex:Church Retreat)"
