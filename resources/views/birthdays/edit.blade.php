...
@section('TopSectionName', 'Edit Leaders')
@section('style')
    <style>
    </style>
@endsection
    ...
    <section class="button-area">
        <div class="container box_1170 border-top-generic">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <form class="form-contact contact_form" id="leadersForm" action="{{ route('leaders.update', $leader) }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="my-2">
                                    @if ($leader->image)
                                        <img src="{{ $leader->image }}" class="rounded border" width="150" height="150"
                                            alt="Program Image">
                                    @endif
