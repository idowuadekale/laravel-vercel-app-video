...
@section('TopSectionName', 'Create New Template')
@section('style')
    <style>
        #unsplash-results {
            max-height: 60vh;
    ...
    <section class="button-area">
        <div class="container box_1170 border-top-generic">
            <div class="row">
                ...
                <div class="col-lg-12">
                    <form class="form-contact contact_form" id="templateForm" action="{{ route('templates.store') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="form-group">
                                    ...
                                    <img src="{{ old('image_url', $template->image_url ?? '') }}"
