...
@section('TopSectionName', 'Edit Epe/Ikeja Executives')
@section('style')
    <style>
    </style>
@endsection
            ...
            <div class="row">
                <div class="col-12">
                    <h2 class="contact-title">
                        Edit Epe/Ikeja Executives Record
                    </h2>
                    <hr>
                ...
                <div class="col-md-12">
                    <form class="form-contact contact_form" action="{{ route('secretaries.update', $secretary) }}"
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="position" id="position" class="form-control" minlength="5"
                                        ...
                                        value="{{ old('position', $secretary->position) }}">
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div class="form-group">
                                ...
                                <div class="my-2">
                                    @if ($secretary->image)
                                        <img src="{{ $secretary->image }}" class="rounded border" width="150"
                                            height="150" alt="Leader Image">
                                    @endif
                            ...
                            <div class="col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input type="url" name="instagram" id="instagram" class="form-control"
                                        ...
                                        value="{{ old('instagram', $secretary->instagram) }}">
                                </div>
                            </div>
                        </div>
