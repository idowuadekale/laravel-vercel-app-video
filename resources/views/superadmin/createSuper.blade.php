...
@section('title', 'Developer Admin - Lasu C&S Chapter')
@section('TopSectionName', 'Create Super Admin')
@section('style')
    <style>
    </style>
@endsection
    ...
    <section class="button-area">
        <div class="container box_1170 border-top-generic">
            <div class="row">
                ...
                <div class="col-md-12">
                    <form class="form-contact contact_form" action="{{ route('developer.storeSuper') }}" method="POST"
                        autocomplete="off">
                        @csrf
